...
output "cluster_security_group_id" {
  ...
  value       = [aws_eks_cluster.eks-cluster.vpc_config[0].security_group_ids]
}
...
output "node_group_private_id" {
  ...
  value       = aws_eks_node_group.eks-ng-private.id
}

output "node_group_private_arn" {
  description = "Private Node Group ARN"
  value       = aws_eks_node_group.eks-ng-private.arn
}

output "node_group_private_status" {
  description = "Private Node Group status"
  value       = aws_eks_node_group.eks-ng-private.status
}

output "node_group_private_version" {
  description = "Private Node Group Kubernetes Version"
  value       = aws_eks_node_group.eks-ng-private.version
}
